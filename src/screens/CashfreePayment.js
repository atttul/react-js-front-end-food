...
const CashfreePaymentForm = () => {
    ...
    const handlePay = async (e) => {
        ...
        try {
            ...
            // Step 2: Launch Cashfree Payment SDK Checkout Modal (Order creation occurs on payment completion)
    ...
    return (
        <div className="d-flex flex-column min-vh-100 position-relative">
            ...
            <div className="container px-2 px-sm-3 d-flex justify-content-center align-items-center flex-grow-1 py-3 py-md-5">
                <div className="card auth-wrapper w-100 border-0 overflow-hidden shadow-lg rounded-4" style={{ maxWidth: '920px' }}>
                    <div className="row g-0">
                        
                        {/* DESKTOP LEFT PANEL (Visible on >= 768px): Order Summary, Sandbox Testing & Info */}
                        <div className="col-md-5 d-none d-md-flex flex-column p-4 p-lg-5 text-white bg-dark bg-opacity-60 border-end border-secondary border-opacity-40">
                            <div className="mb-3">
                                <span className="auth-badge mb-2">
                                    <i className="bi bi-shield-check text-warning me-1"></i> Sandbox Test Gateway
                                </span>
                                <h3 className="fw-extrabold text-white mb-1">Order Summary</h3>
                                <p className="text-white-50 extra-small leading-relaxed mb-0">
                                    Review order total and delivery details before completing test payment.
                                </p>
                            </div>

                            {/* Order Price Breakdown Card */}
                            <div className="bg-dark p-3 rounded-3 border border-secondary mb-3 shadow-sm">
                            ...
                            {/* Sandbox Test Notice & Steps */}
                            <div className="p-3.5 rounded-3 border border-warning border-opacity-40 bg-warning bg-opacity-10 mb-3 text-start shadow-sm">
                                <div className="d-flex align-items-center gap-1.5 text-warning fw-bold mb-1.5" style={{ fontSize: '0.72rem' }}>
                                    <i className="bi bi-info-circle-fill fs-6"></i>
                                    <span>TEST / SANDBOX PAYMENT MODE</span>
                                </div>
                                <p className="text-white-50 mb-2" style={{ fontSize: '0.7rem', lineHeight: '1.4' }}>
                                ...
                                <div className="fw-bold text-white mb-1.5" style={{ fontSize: '0.7rem' }}>How to place order in Sandbox:</div>
                                <ol className="text-white-50 ps-3.5 mb-0 d-flex flex-column gap-1.5" style={{ fontSize: '0.68rem', lineHeight: '1.38' }}>
                                    <li>Enter your Delivery Name, Address & Phone.</li>
                                    <li>Click <strong className="text-white">Proceed to Pay</strong> button.</li>
                                    <li>On payment gateway page, select <strong className="text-white">Kotak Mahindra Bank Card</strong> (or Netbanking/UPI Test).</li>
                                    <li>Enter demo OTP <code className="text-warning">111000</code> (or click <strong className="text-success">Success</strong>) and your test payment will be done!</li>
                                </ol>
                            </div>

                            {/* Auto Accept Note */}
                            <div className="p-3 rounded-3 border border-info border-opacity-40 bg-info bg-opacity-10 mb-3 text-start shadow-sm">
                                <div className="d-flex align-items-center gap-1.5 text-info fw-bold mb-1" style={{ fontSize: '0.72rem' }}>
                                    <i className="bi bi-clock-history fs-6"></i>
                                    <span>3-MINUTE AUTO-ACCEPTANCE NOTE</span>
                                </div>
                                <p className="text-white-50 mb-0" style={{ fontSize: '0.68rem', lineHeight: '1.4' }}>
                                    Once placed, if not manually reviewed by admin within <strong>3 minutes</strong>, your order will be <strong className="text-info">automatically accepted</strong>!
                                </p>
                            </div>

                            {/* SSL Badges */}
                            <div className="mt-auto pt-2 border-top border-secondary border-opacity-50">
                                <div className="d-flex flex-column gap-1 text-white-50 extra-small">
                        ...
                        {/* RIGHT MAIN PANEL (Mobile + Desktop Form & Mobile Guidance) */}
                        <div className="col-md-7 p-3.5 p-sm-4 p-lg-5 d-flex flex-column justify-content-center">
                            
                            {/* Mobile Header Banner (< 768px) */}
                            <div className="d-md-none mb-3 text-center">
                                <div className="d-inline-flex align-items-center gap-1.5 px-3 py-1 rounded-pill bg-dark border border-warning-subtle mb-2">
                                    <i className="bi bi-shield-check text-warning extra-small"></i>
                                    <span className="text-warning extra-small fw-bold">SANDBOX DEMO CHECKOUT</span>
                                </div>
                                <h4 className="fw-bold text-white mb-1">Confirm Delivery & Pay</h4>
                                <p className="text-white-50 extra-small mb-0">Fill your delivery details below to place order</p>
                            </div>

                            {/* Mobile Payable Total Card (< 768px) */}
                            <div className="d-md-none bg-dark p-3.5 rounded-3 border border-secondary mb-3 d-flex align-items-center justify-content-between shadow-sm">
                                <div className="d-flex flex-column text-start">
                                    <span className="text-white-50 extra-small fw-semibold">Grand Total Amount</span>
                                    <span className="text-success extra-small fw-bold"><i className="bi bi-check-circle-fill me-1"></i>Free Delivery & Taxes Included</span>
                                </div>
                                <span className="fs-4 fw-extrabold text-warning">₹{form.amount}/-</span>
                            </div>

                            {/* Mobile Sandbox Test Guide Box (< 768px) */}
                            <div className="d-md-none p-3.5 rounded-3 border border-warning border-opacity-40 bg-warning bg-opacity-10 mb-3 text-start shadow-sm">
                                <div className="d-flex align-items-center gap-1.5 text-warning fw-bold mb-1.5" style={{ fontSize: '0.72rem' }}>
                                    <i className="bi bi-info-circle-fill fs-6"></i>
                                    <span>TEST / SANDBOX PAYMENT MODE</span>
                                </div>
                                ...
                                <div className="fw-bold text-white mb-1.5" style={{ fontSize: '0.7rem' }}>Quick Steps to Place Test Order:</div>
                                <ol className="text-white-50 ps-3.5 mb-2.5 d-flex flex-column gap-1.5" style={{ fontSize: '0.68rem', lineHeight: '1.38' }}>
                                    <li>Enter Delivery Name, Address & Phone below.</li>
                                    <li>Tap <strong className="text-white">Proceed to Pay ₹{form.amount}/-</strong>.</li>
                                    <li>On payment gateway page, select <strong className="text-white">Kotak Mahindra Bank Card</strong> (or Netbanking/UPI Test).</li>
                                    <li>Enter demo OTP <code className="text-warning">111000</code> (or click <strong className="text-success">Success</strong>) and your test payment will be done!</li>
                                </ol>
                                <div className="pt-2 border-top border-warning border-opacity-30 text-info" style={{ fontSize: '0.68rem', lineHeight: '1.35' }}>
                                    <i className="bi bi-clock-history me-1"></i>
                                    <strong>3-Min Auto-Accept:</strong> Placed orders are auto-accepted by system in 3 minutes!
                                </div>
                            </div>

                            {/* Desktop Title Header (>= 768px) */}
                            <div className="d-none d-md-block mb-3 text-start">
                            ...
                            <form onSubmit={handlePay}>
                                ...
                                <div className="mb-3 text-start">
                                    <label htmlFor="name" className="form-label text-white-50 fw-semibold extra-small mb-1">
                                        Full Name
                                    </label>
                                ...
                                {/* Delivery Address */}
                                <div className="mb-3 text-start">
                                    <label htmlFor="address" className="form-label text-white-50 fw-semibold extra-small mb-1">
                                        Delivery Address
                                    </label>
                                    <div className="input-group auth-input-group">
                                ...
                                <div className="mb-4 text-start">
                                    <label htmlFor="phone" className="form-label text-white-50 fw-semibold extra-small mb-1">
                                ...
                                <div className="d-flex align-items-center justify-content-between pt-2 border-top border-secondary border-opacity-50">
                                    <button
                                        type="button"
                                        className="btn btn-link text-white-50 p-0 text-decoration-none small d-flex align-items-center gap-1"
                                    ...
                                    <Link
                                        to="/"
                                        className="text-warning text-decoration-none small d-flex align-items-center gap-1 fw-semibold"
                                    >
